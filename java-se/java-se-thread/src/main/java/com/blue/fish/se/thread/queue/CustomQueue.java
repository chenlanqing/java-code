 ...
 */
@Slf4j
public class CustomQueue<T> implements BaseQueue<T> {
     ...
     * 自定义队列元素
     */
    class CustomQueueNode extends Node<T> {
        public CustomQueueNode(T item) {
            super(item);
        }
    }
    ...
    public CustomQueue() {
        ...
        head = tail = new CustomQueueNode(null);
    }
    ...
    public boolean put(T item) {
        ...
        try {
            ...
            // 追加到队尾
            tail = tail.next = new CustomQueueNode(item);
    ...
    public T take() {
        ...
        try {
            ...
            head.item = null;
            // 重新设置头结点的值
            head = (CustomQueueNode) expectHead;
