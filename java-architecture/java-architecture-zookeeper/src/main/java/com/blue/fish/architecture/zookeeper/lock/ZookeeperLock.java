package com.blue.fish.architecture.zookeeper.lock;
...
public class ZookeeperLock implements Watcher {
    ...
    private boolean tryLock(){
        ...
        try {
            ...
            myzkNode = zk.create(root + "/" + splitStr, new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL);
            // 获取根节点下的所有子节点
